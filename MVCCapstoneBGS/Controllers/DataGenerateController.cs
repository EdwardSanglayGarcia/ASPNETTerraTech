...
namespace MVCCapstoneBGS.Controllers
{
    ...
    public class DataGenerateController : Controller
    {
        ...
        public void TweetArea(string message)
        {
            ...
            using (var w = new WebClient())
            {
                image = Server.MapPath("~/TerraAssets/Photo/Area Report.png");
            }
            ...
            using (var excelPackage = new ExcelPackage(memoryStream))
            {
                ...
                try
                {
                   ...
                   // string DENRLogo = @"C:\Users\pc\Desktop\Photo\DENRLogo.png";
                    ...
                    using (var w = new WebClient())
                    {
                        DENRLogo = Server.MapPath("~/TerraAssets/Photo/DENRLogo.png");
                    }
                   ...
                   // string PHLogo = @"C:\Users\pc\Desktop\Photo\PHLogo.png";
                    ...
                    using (var w = new WebClient())
                    {
                        PHLogo = Server.MapPath("~/TerraAssets/Photo/PHLogo.png");
                    }
